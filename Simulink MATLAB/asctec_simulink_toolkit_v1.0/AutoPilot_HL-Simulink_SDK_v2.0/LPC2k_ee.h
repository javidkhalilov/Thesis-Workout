...
/************************************************************************/
#include "main.h"
#define EE_BUFFER_SIZE sizeof(matlab_params)
...
#ifndef _EEPROM_
	extern unsigned char ee_erase(void);
	extern unsigned char ee_write(unsigned int *buffer);
	extern void ee_read(unsigned int *buffer);
#endif
