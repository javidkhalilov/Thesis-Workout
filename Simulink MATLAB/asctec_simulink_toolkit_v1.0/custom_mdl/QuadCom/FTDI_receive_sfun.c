...
#define S_FUNCTION_NAME FTDI_receive_sfun
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SOURCEFILES "__SFB__ftditools.c"
#define PANELINDEX           6
...
extern void FTDI_receive_sfun_Outputs_wrapper(const int32_T *BaudRate,
                          int16_T *data_out,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    FTDI_receive_sfun_Outputs_wrapper(BaudRate, data_out, data_new_flag, HL_Status);
}
