...
#define S_FUNCTION_NAME FTDI_send_sfun
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          2
/* Input Port  0 */
#define IN_PORT_0_NAME      data_send
...
/* Input Port  1 */
#define IN_PORT_1_NAME      BaudRate
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      bytes_sent
...
#define SOURCEFILES "__SFB__ftditools.c__SFB__ftd2xx.dll"
#define PANELINDEX           6
...
extern void FTDI_send_sfun_Outputs_wrapper(const int16_T *data_send,
...
{
    const int16_T   *data_send  = (const int16_T*) ssGetInputPortSignal(S,0);
    const int32_T   *BaudRate  = (const int32_T*) ssGetInputPortSignal(S,1);
    int16_T        *bytes_sent  = (int16_T *)ssGetOutputPortRealSignal(S,0);

    FTDI_send_sfun_Outputs_wrapper(data_send, BaudRate, bytes_sent);
}
