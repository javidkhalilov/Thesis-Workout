...
%     disp('Connected to remote API server');
    ...
    error=vrep.simxSetStringSignal(clientID,'W',st,vrep.simx_opmode_oneshot_wait);
  ...
  %end
        ...
        block.ContStates.Data(13) = SD(13);
        block.ContStates.Data(14) = SD(14);
        block.ContStates.Data(15) = SD(15);
        block.ContStates.Data(16) = SD(16);

        %vrep.simxPauseSimulation(clientID);
